...
function RankingCard({ rank, userName, score }) {
  const rankColors = {
    1: "rank-first", // 1등 색상
    2: "rank-second", // 2등 색상
    3: "rank-third", // 3등 색상
  ...
  const rankClass = rankColors[rank] || "default-rank"; // 해당 순위 색상 또는 기본 색상


  return (
    <div className={`cards ${rankClass}`}>
        ...
        >
          <defs>
            ...
            >
              ...
              <stop
                offset="100%"
                style={{ stopColor: "#FFEC8B", stopOpacity: 1 }}
              />
            </linearGradient>
            {/* Silver gradient */}
            <linearGradient
            ...
            >
              ...
              <stop
                offset="100%"
                style={{ stopColor: "#D4A17A", stopOpacity: 1 }}
              />
            </linearGradient>
            {/* Light blue gradient */}
            <linearGradient
      ...
      <div className="detailPage">
        ...
        <div className="gradesBox">
          ...
          <div className="gradesBoxNum">{parseFloat(score).toFixed(2)}</div>
        </div>
      </div>
    </div>
  );
