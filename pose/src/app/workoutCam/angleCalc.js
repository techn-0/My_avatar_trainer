...
//# 7,8 Ear / 11,12  Shoulder / 13,14 elbow / 23,24 waist / 25,26 knee / 27,28 ankle

export const angleCalc = (data, side, landidx1, landidx2, landidx3) => {
    // Index Ear = 0, Neck = 1, Elbow = 2, Waist = 3, Knee = 4, Ankle = 5
    const LandmarkList = [[7,8], [11,12], [13,14], [23, 24], [25,26], [27,28]]
